...
// this() : 같은 클래스 안에 있는 생성자를 호출하는 의미로 사용
class MyDate10 {
	...
	// 생성자 오버로딩 : 한개의 클래스에 여러개의 생성자를 정의하는 것
	// : 매개변수의 자료형, 매개변수의 개수, 매개변수의 순서
	public MyDate10() {					// 기본 생성자
		this(2016, 1, 1); 				// 같은 클래스 안에 있는 생성자 호출
	}

	public MyDate10(int new_year) {
		this(new_year, 1, 1); 			// 같은 클래스 안에 있는 생성자 호출
	}
